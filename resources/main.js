...
`+choose_row_btn
    ...
    [text(''), 'm0_0_1', image('m0_0_1'), parseRef(unit='', lesson='', 13,1), "graphs", "حل المعادلة", choose_row_btn],
    [text(''), 'm0_0_2_1', image('m0_0_2_1'), parseRef(unit='', lesson='', 13,1), '', '', choose_row_btn],
    [text(''), 'm0_0_2_2', image('m0_0_2_2'), parseRef(unit='', lesson='', 13,1), '', '', choose_row_btn],
    [text(''), 'm0_0_2_3', image('m0_0_2_3'), parseRef(unit='', lesson='', 13,1), '', '', choose_row_btn],
